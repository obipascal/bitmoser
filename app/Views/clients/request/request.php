...
<head>
    ...
    <meta name="description" content="Service request Log">
                            ...
                            <div class="card mb-5">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-xl-4">
                                            ...
                                            <div class="bs-xl-bank-menu mb-2">
                                                <ul class="nav nav-pills flex-column mt-2">
                                                    <!-- Start: Balance -->
                                                    <li class="nav-item mb-1"><a class="nav-link active" href="request.html"><strong>&nbsp;New Request</strong></a></li>
                                                    <!-- End: Balance -->
                                                    <!-- Start: Top-Up Wallet -->
                                                    <li class="nav-item"><a class="nav-link active mb-1 show-topUp" href="accpted.html" data-target="#bstopUpMd"><strong>Accepted Request</strong></a></li>
                                                    <!-- End: Top-Up Wallet -->
                                                </ul>
                                            </div>
                                            <!-- End: Items -->
                                            <!-- Start: Mobile Items -->
                                            <div>
                                                <div class="bs-sm-bank-menu mb-4"><a class="btn btn-primary btn-block text-left" data-toggle="collapse" aria-expanded="false" aria-controls="collapse-1" role="button" href="#collapse-1"><i class="fa fa-th-list"></i>&nbsp;Menu</a>
                                                    <div class="collapse"
                                                        id="collapse-1">
                                                        <ul class="nav nav-pills flex-column mt-2">
                                                            <!-- Start: Balance -->
                                        ...
                                        <div class="col">
                                            <header>
                                                <h1 class="bs-color">Newly Request</h1>
                                                <hr>
                                            </header>
                                            <!-- Start: Logger -->
                                            <section class="border rounded py-4 p-4" style="background-color: #e2e2e2;">
                                                <div class="row">
                                                    <div class="col-xl-4">
                                                        <!-- Start: Request Card -->
                                                        <div class="card border-light border rounded shadow mb-3 request_card">
                                                            <div class="card-body">
                                                                <h6 class="card-title bs-color">Software Development</h6>
                                                                <h6 class="text-muted card-subtitle mb-2">@client name</h6><small class="text-muted" style="display: block;font-size: 9px;">&nbsp;<i class="fa fa-clock-o"></i>&nbsp;12:30 on &nbsp;<i class="fa fa-calendar"></i>&nbsp; March 21, 2020&nbsp;</small>
                                                                <div
                                                                    class="btn-group btn-group-sm mt-2" role="group"><button class="btn btn-primary accept_request" type="button">Accept&nbsp;</button><button class="btn btn-primary busy_request" type="button">I'm busy</button></div>
                                                        </div>
                                                    </div>
                                                    <!-- End: Request Card -->
                                                </div>
                                ...
                                <div class="card border-light border rounded shadow mb-3 request_card">
                                    <div class="card-body">
                                        ...
                                        <div class="btn-group btn-group-sm mt-2"
                                            role="group"><button class="btn btn-primary accept_request" type="button">Accept&nbsp;</button><button class="btn btn-primary busy_request" type="button">I'm busy</button></div>
                                    </div>
                                </div>
                                <!-- End: Request Card -->
                            </div>
