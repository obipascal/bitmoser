...
<head>
    ...
    <meta name="description" content="Withdraw, View payment History">
                                        ...
                                        <div class="col">
                                            <div class="card">
                                                <div class="card-header bs-bg" style="color: #f5f5f5;">
                                                    <h5 class="mb-0">Payments<a class="btn btn-primary text-warning border rounded shadow float-right show-topUp" role="button" href="#withdrawal" data-target="#bstopUpMd"><strong>Withdrawal</strong></a></h5>
                                                </div>
                                                <div class="card-body">
