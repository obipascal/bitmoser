...
<main>
    <div class="container-fluid">
        <div class="row mh-100vh">
            <!-- Start: Signup block -->
            <div class="col-10 col-sm-8 col-md-6 col-lg-6 offset-1 offset-sm-2 offset-md-3 offset-lg-0 align-self-center d-lg-flex align-items-lg-center align-self-lg-stretch bg-white p-5 rounded rounded-lg-0 my-5 my-lg-0" id="Signup-block">
                    ...
                    <?php if (isset($is_active) && !$is_active) : ?>
                        ...
                        <form class="p-4">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control auth_input" type="text" name="auth_firstname" required="" pattern="[A-Z]+[a-z]+[^_*$%£@~#()]" >
                            </div>
                            <!-- End: Name -->
                            <!-- Start: Name -->
                            <div class="form-group">
                                <label class="text-secondary">First Name*</label>
                                <input class="form-control auth_input" type="text" name="auth_lastname" required="" pattern="[A-Z]+[a-z]+[^_*$%£@~#()]" >
                            </div>
                            <!-- End: Name -->
                            <!-- Start: Name -->
                            <div class="form-group">
                                <label class="text-secondary">Last Name&nbsp;<small>(Optional)</small></label>
                                <input class="form-control auth_input" type="text" name="auth_middlename" pattern="[A-Z]+[a-z]+[^_*$%£@~#()]" >
                            </div>
                            <!-- End: Name -->
                            <!-- Start: Name -->
                            <div class="form-group">
                                ...
                                <input class="form-control auth_input" type="tel" name="auth_phoneNumber" required="" maxlength="14" minlength="14" pattern="[+][234]+[0-9]{2,15}$">
                            </div>
                            <!-- End: Name -->
                            <!-- Start: Email -->
                            <div class="form-group">
                                <label class="text-secondary">Email*</label>
                                <input class="form-control auth_input" type="email" name="auth_email" required="" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,15}$">
                            </div>
                            <!-- End: Email -->
                            <!-- Start: Password -->
                            <div class="form-group">
                                <label class="text-secondary">Password*</label>
                                <input class="form-control auth_input" type="password" name="auth_password" required="" maxlength="12" minlength="6" pattern="[A-Za-z]+[0-9]+[^A-Za-z0-9_]$">
                            </div>
                            <!-- End: Password -->
                            <!-- Start: Password -->
                            <div class="form-group">
                                <label class="text-secondary">Confirm Password*</label>
                                <input class="form-control auth_input" type="password" name="auth_confirmPassword" required="" maxlength="12" minlength="6" pattern="[A-Za-z]+[0-9]+[^A-Za-z0-9_]$">
                            </div>
                            <!-- End: Password -->
                            <!-- Start: Password Guid -->
