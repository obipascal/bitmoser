<section class="features-boxed">
	...
	<div class="container" id="apps">
		...
		<div class="row no-gutters d-flex" id="contact" style="background-color: #ffffff;padding: 15px;">
			<div class="col-md-6">
				<!-- <img class="rounded-circle img-fluid border border-warning" src="<?= base_url(); ?>/assets/img/gravater/user.png?h=25a56d70d87dad0ef06160523bd08873" width="350" height="350" id="preview-picture" style="margin: auto;display: block;width: 50%;"> -->
				<div class="row">
					<div class="col">
						<div class="jumbotron">
							<h1 class="text-info">Form Guide</h1>
							<hr>
							<p>All fields with * are required and must be provided.</p>
							<p>Some selection option are selected my default please do check the form before submiting.</p>
							<p>A temperary password  and permanent User ID will be generated. Copy the password and user ID, this will be required for login.</p>
							<p>To change any information after submition, you will be required to fill a complain form for User correction and submit for effective security reason.</p>
				...
				<form class="border rounded-0 border-warning p-3" id="createRendererForm">
					...
					<section class="client-signup-form-sections">
						...
						<div class="form-row">
							...
							<div class="col-md-12">
								<label><strong>Occupation</strong><strong class="required-stared">*</strong></label>
								<div id="lp-name-wrapper">
								...
								<div id="lp-name-wrapper">
									<label><strong>Gender</strong><strong class="required-stared">*</strong></label>
