                            ...
                            <div class="card mb-5">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <header>
                                                <h1 class="bs-color">Accepted Request</h1>
                                                <hr>
                                            </header>
                                            <!-- Start: Logger -->
                                                    ...
                                                    <div class="col-xl-4">
                                                        ...
                                                        <div class="card border-light border rounded shadow mb-3 request_card">
                                                            <div class="card-body">
                                                                ...
                                                                <div
                                                                    class="btn-group btn-group-sm mt-2" role="group"><button class="btn btn-primary accepted" type="button">Accepted&nbsp;</button><button class="btn btn-primary confirm_request" type="button">Confirm</button></div>
                                                        </div>
                                                    </div>
                                                    <!-- End: Request Card -->
                                                </div>
