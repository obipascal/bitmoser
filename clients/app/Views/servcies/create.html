...
<head>
    ...
    <title>Create Service - Dashboard</title>
                                ...
                                <div class="card-body">
                                    <div>
                                        <ul class="nav nav-tabs bg-light border rounded shadow-sm">
                                            <li class="nav-item"><a class="nav-link active" role="tab" data-toggle="tab" href="#tab-1"><i class="fa fa-briefcase bs-fa-mutted"></i><strong>&nbsp;CREATE NEW SERVICE</strong></a></li>
                                        </ul>
                                        <div class="tab-content">
                                            <div class="tab-pane fade show active" role="tabpanel" id="tab-1">
                                                <p class="text-center mt-4 bs-color">Create new services by "clicking" the "Add Service" button to add more services.</p>
                                                <div class="card shadow-sm" style="margin: 2rem;">
                                                    <div class="card-header border rounded-0" style="background-color: #464a6c;color: #f5f5f5;">
                                                        <h2 class="mb-0">Your Services</h2><small class="text-warning" style="color: #eac70e;"><strong>Note: </strong>The service created here are restricked to your subscription plan. Currently your have created {$no} of {$no} left per your subscription. <a href="#">Upgrade </a>to a greater sub plan to add more services.</small>
                                                        <hr>
                                                    </div>
                                                    <div class="card-body">
                                                        <div class="table-responsive table-borderless bg-light border rounded-0 service-item-table">
                                                        ...
                                                        <div class="align-btn" align="right"><button class="btn btn-primary border rounded-0 create-service-item" type="button" style="background-color: #eac70e;display: block;color: #464a6c;">Add Service</button></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
