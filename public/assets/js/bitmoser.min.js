...
bs.loader =  (selector,success='bs_xhr_success', msg = 'Your request Was successful!') => {
 ...
 */
 ...
 bs.alertTemplate = () => {
    $('body').append(
         `
         <div class="alert alert-info border rounded-0 shadow-lg bs_b_alert" role="alert" style="position: fixed !important;width: 100% !important;z-index: 100000 !important;top: -130px !important;" data-show="false">
    ...
    <h4
        class="alert-heading"><i class="alert_icon fas fa-bell shadow-lg text-info"></i>
     ...
     */
     ...
     switch (type) {
        case "danger":
             ...
             var icontype = $(document).fin('.alert_icon').attr('class');
             var colortype = $(document).fin('.alert_icon').attr('class');
             ...
             //change the icon
             for(i; i < size; i++){
                 if(typeof(alerttype) != 'undefined' && typeof(icontype) === 'string' && icontype.includes(alertAllowedIcons[i]))
                 {
             ...
             for(i; i < size; i++){
                 ...
                 {
                    $(document).find('.alert_icon').removeClass(alertAllowedTypesIconColors[i]).delay(200).addClass(alertIconColors[type]);
                 }
             }
